...
- **Менеджер юзерскриптов** — установка по URL или из файла, переустановка, тогглы, предустановленный Vanilla+ и EUI/CUI в один клик без ввода URL, выбор любой версии с GitHub, обнаружение конфликтов, безопасная инжекция с поддержкой `@run-at`, JS-бриджи (clipboard, share, настройки игры)
...
- **WebView с игрой** — полноэкранный immersive-режим, геолокация, синхронизация темы и языка из настроек игры, перезагрузка из настроек, выдвижной drawer с pull-tab
