...
- Двухрежимная кнопка настроек SBG Scout:
  - **Режим загрузки** (игра ещё не инициализирована) — большая нативная `MaterialButton` «Настройки SBG Scout» по центру по горизонтали, 20 % от высоты видимой области снизу
