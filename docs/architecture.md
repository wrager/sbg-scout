...
- Маленькая кнопка с иконкой приложения в правом верхнем углу открывает экран настроек; пока настройки открыты, кнопка скрыта
...
9. Пользователь тапает кнопку-иконку приложения → экран настроек с `SettingsFragment`; отсюда можно открыть управление скриптами, запустить проверку обновлений или баг-репорт
